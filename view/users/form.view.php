...
$isEdit = $mode === 'edit';
$action = $isEdit
    ? '/students/' . View::escape((string) ($studentId ?? '')) . '/update'
    : '/students';
?>
<section class="stack">
    <div class="card" style="max-width: 620px;">
        <h1 class="title" style="font-size: 28px;"><?= $isEdit ? 'Edit Student' : 'Create Student' ?></h1>
        <p class="subtitle">Manage student account information for your class.</p>
        ...
        <form class="form" action="<?= $action ?>" method="post" style="max-width:none;">
            <label>
                ...
                <input class="input" type="text" name="name" value="<?= View::escape((string) ($form['name'] ?? '')) ?>" required>
            </label>
            ...
            <label>
                ...
                <input class="input" type="text" name="username" value="<?= View::escape((string) ($form['username'] ?? '')) ?>" required>
            </label>
            ...
            <div style="display:flex;gap:10px;flex-wrap:wrap;">
                ...
                <a class="pill" href="/students">Cancel</a>
            </div>
        </form>
    </div>
</section>
